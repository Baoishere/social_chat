        ...
        child: FutureBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text('Không tìm thấy trạng thái!'));
            } else {
              ...
              return StoryPageView(
                ...
                itemBuilder: (context, pageIndex, storyIndex) {
                  StatusModel stats = StatusModel.fromJson(
                    status[storyIndex].data() as Map<String, dynamic>,
                  );

                  // Kiểm tra null cho url trước khi sử dụng
                  if (stats.url != null) {
                    // Cập nhật số người xem nếu chưa có
                    ...
                    if (allViewers!.contains(firebaseAuth.currentUser!.uid)) {
                      ...
                      // Cập nhật viewCount cho trạng thái
                      statusRef
                          .doc(widget.statusId)
                          .collection('statuses')
                          .doc(stats.statusId)
                    ...
                    return Center(child: Text('Không có hình ảnh nào có sẵn'));
                  }
                },
